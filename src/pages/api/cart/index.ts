import { addData, RetrieveDataByField, RetrieveDataWithJoin, updateData } from "@/lib/supabase/service";
...
async function handler(req: NextApiRequest & {user? : any}, res: NextApiResponse) {
  if (req.method === "GET") {
    ...
    const { data: existingItem, error: itemError } = await RetrieveDataByField(
      "cart_items",
