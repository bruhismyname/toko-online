              ...
              <div key={cartItem.id}>
                {cartItem.cart_items.map((item: any) => {
                  ...
                  return (
                    <div
                      key={item.id}
                      className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm mb-4"
                    >
                        ...
                        <div className="flex-1 flex flex-col">
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-3 mt-4">
                              ...
                              <button
                                onClick={() =>
                                  handleDecreaseQty(item.product.id, cartId)
                                }
                              ...
                              <button
                                onClick={() =>
                                  handleIncreaseQty(item.product.id, cartId)
                                }
                                className="w-9 h-9 rounded-lg border-2 border-gray-300 flex items-center justify-center hover:bg-gray-100 hover:border-gray-400 transition font-semibold text-gray-700 text-lg"
                              >
                                +
                          ...
                          <div className="mt-4">
                            <button
                              onClick={() =>
                                handleDelete(item.product.id, cartId)
                              }
